...
$(DEBUG_DIR)/$(OBJECT_VIEWER_FILE): $(DEBUG_DIR)/$(LIB_RENDER_FILE)
$(RELEASE_DIR)/$(OBJECT_VIEWER_FILE): $(RELEASE_DIR)/$(OPEN_BVE_API_FILE)
$(RELEASE_DIR)/$(OBJECT_VIEWER_FILE): $(RELEASE_DIR)/$(LIB_RENDER_FILE)
...
$(DEBUG_DIR)/$(OBJECT_VIEWER_FILE) $(RELEASE_DIR)/$(OBJECT_VIEWER_FILE): $(OBJECT_VIEWER_SRC) $(OBJECT_VIEWER_RESOURCE)
	...
	/reference:$(OPEN_BVE_API_OUT) /reference:$(LIB_RENDER_OUT) /reference:$(OUTPUT_DIR)/OpenTK.dll /reference:System.Core.dll \
